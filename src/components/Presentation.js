      ...
      <div className="features__inner p-relative z-index-1 white-bg mb-5">
        <div className="row">
          <div className="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
            <div className="features__item features__border-right d-sm-flex align-items-start white-bg mb-5">
              <div className="features__icon me-3">
                <svg
                  width="42"
                  height="44"
                  viewBox="0 0 42 44"
              ...
              <div className="features__content">
                ...
                <p>Terminez votre cursus pour obtenir un certificat</p>
              </div>
            </div>
          </div>
          <div className="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
            <div className="features__item features__border-right d-sm-flex align-items-start white-bg mb-5">
              ...
              <div className="features__content">
                <h3 className="features__title">
                  <p>Formation a domicile</p>
                </h3>
                <p>Obtenez de l'aide et du soutien de vos pairs</p>
              </div>
            </div>
          </div>
          <div className="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
            <div className="features__item features__border-right d-sm-flex align-items-start white-bg mb-5">
              ...
              <div className="features__content">
                ...
                <p>
                  Apprenez à votre propre rythme et selon votre disponibilité
                </p>
              </div>
            </div>
          </div>
